...
import org.meatball.quiz.bot.categories.geography.country.button.impl.CountryFourChoicesButtonCommandHandler
...
enum class CountryButtonCommand(override val key: String, override val service: ButtonCommandService): ButtonCommand {
    ...
    FOUR_CHOICES("c4c", CountryFourChoicesButtonCommandHandler()),
}